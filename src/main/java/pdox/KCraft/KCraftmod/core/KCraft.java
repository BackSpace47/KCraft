...
import pdox.KCraft.KCraftmod.item.itemneedleSpeed;
import pdox.KCraft.KCraftmod.item.itemneedleStamana;
import pdox.KCraft.KCraftmod.item.itemswordPeridot;
import pdox.KCraft.KCraftmod.item.itemswordPyrope;
import pdox.KCraft.KCraftmod.item.itemswordRhodolite;
import pdox.KCraft.KCraftmod.item.itemvitimins;
import pdox.KCraft.KCraftmod.item.itemwrap;
...
public class KCraft {
	...
	public static ToolMaterial PeridotToolMaterial;
	public static ToolMaterial PyropeToolMaterial;
	public static ToolMaterial RhodoliteToolMaterial;
	...
	public static CreativeTabs RPCoreBTab = new CreativeTabs(modid) {
	    ...
	    public Item getTabIconItem() {
	        return Item.getItemFromBlock(KCraft.mediKit);
	    }
	};
	public static CreativeTabs RPCoreITab = new CreativeTabs(modid) {
	    @SideOnly(Side.CLIENT)
	    public Item getTabIconItem() {
	        return KCraft.antiseptic;
	    }
	};
	...
	public void preInit(FMLPreInitializationEvent e){
		...
		PeridotToolMaterial = EnumHelper.addToolMaterial("Peridot", 4, 35, 16F, 7F, 50);
		PyropeToolMaterial = EnumHelper.addToolMaterial("Pyrope", 4, 35, 16F, 7F, 50);
		RhodoliteToolMaterial = EnumHelper.addToolMaterial("Rhodolite", 4, 35, 16F, 7F, 50);
